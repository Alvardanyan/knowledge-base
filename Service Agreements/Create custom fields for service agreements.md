# Create custom fields for service agreements
...
1. Go to the top toolbar and click Settings > Operations > Custom Fields.
2. Click Add.
...
5. From the Type dropdown, select the information you want the field to include:
   a. Text: Letters, numbers, and symbols
   
   b. Dropdown: A list of items to select from. Enter the first item in the list in the Option 1 field, then Click to add option to add another field.
...
2. From Step 1. Summary and Design screen, find the name of your custom field, and enter the value.
